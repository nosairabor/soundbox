...
import SubFooter from "../utils/subFooter";
...
const Home = () => {
  ...
  return (
    <>
    {loading ? (
      <div className="flex justify-center items-center h-screen -mt-[40px] md:-mt-[60px]">
        <ClipLoader color={'#0066FF'} size={70} loading={loading}/>
      </div>
    ):(
      <>
